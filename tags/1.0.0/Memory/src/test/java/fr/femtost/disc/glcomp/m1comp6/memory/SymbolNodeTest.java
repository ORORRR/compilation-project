...
public class SymbolNodeTest {
    ...
    public void getIdentTest() {
        String ident = "x";
        SymbolNode symbolNode = new SymbolNode(ident, "global", Kind.VARIABLE, Type.INTEGER);
    ...
    public void getScopeTest() {
        String scope = "global";
        SymbolNode symbolNode = new SymbolNode("x", scope, Kind.VARIABLE, Type.INTEGER);

        Assert.assertEquals(symbolNode.getScope(), scope);
    }
    ...
    public void addValueTest() throws InvalidTypeException, WrongSymbolException {
        ...
        ValueNode<Integer> valueNode2 = new ValueNode<Integer>(value, symbolNode);
    ...
    public void addValueWrongSymbolTest() throws InvalidTypeException, WrongSymbolException {
        SymbolNode symbolNode = new SymbolNode("x", "global", Kind.VARIABLE, Type.INTEGER);
        ValueNode<Integer> valueNode = new ValueNode<Integer>(0);
